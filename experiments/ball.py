...
def run_instance(counter, d, l, k, solver, preconditioner, sequence, s, cheby_kind, cycle_type):
            ...
            for cheby_kind in ["1st kind", "4th kind"]:
                ...
                for cycle_type in cycle_types:
                    for sequence in ["bisect", "go to one", "decrease by one"]:
                        for s in range(1, 6):
                            run_instance(counter, d, l, k, solver, preconditioner, sequence, s, cheby_kind, cycle_type)
                            counter = counter + 1;
