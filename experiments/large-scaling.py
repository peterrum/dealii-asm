...
def main():
    ...
    for l in range(0, 12):
        run_instance(counter, d, l, "large-scaling_diag.json")
        counter = counter + 1;

        run_instance(counter, d, l, "large-scaling_fdm1.json")
        counter = counter + 1;

        run_instance(counter, d, l, "large-scaling_fdm2.json")
        counter = counter + 1;

        run_instance(counter, d, l, "large-scaling_fdmv.json")
        counter = counter + 1;
