...
def main():
    ...
    for l in range(0, 12):
        run_instance(counter, d, l, "large-scaling-opt_diag.json")
        counter = counter + 1;

        run_instance(counter, d, l, "large-scaling-opt_fdm1.json")
        counter = counter + 1;

        run_instance(counter, d, l, "large-scaling-opt_fdm2.json")
        counter = counter + 1;

        run_instance(counter, d, l, "large-scaling-opt_fdmv.json")
        counter = counter + 1;
